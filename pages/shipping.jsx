...
export default function ShippingScreen() {
  ...
  const submitHandler = ({ fullName, postalCode, country, address, city }) => {
    dispatch({
      type: 'SAVE_SHIPPING_ADDRESS',
      payload: { fullName, postalCode, country, address, city },
    });
    Cookies.set(
      'cart',
      JSON.stringify({
        ...
        <div className="mb-4">
          ...
          <input
            ...
            {...register('address', {
              ...
              minLength: { value: 3, message: 'Address must contain 3 or more chars' },
            })}
          />
